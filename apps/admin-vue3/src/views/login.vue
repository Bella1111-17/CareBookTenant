<template>
  ...
  <div class="login">
    <el-form ref="loginRef" :model="loginForm.model" :rules="loginForm.rules" class="login-form">
      <h3 class="title">众保康【AI】智护家</h3>
      <el-form-item prop="userName">
        <el-input v-model.trim="loginForm.model.userName" maxlength="30" type="text" size="large" auto-complete="off" placeholder="账号">
          <template #prefix>
    ...
    <div class="el-login-footer">
      <span>Copyright © 2026 众保康【AI】智护家 All Rights Reserved.</span>
    </div>
  </div>
</template>
