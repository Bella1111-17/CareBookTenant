...
import { PLATFORM_USER_SCOPE, UserScope } from 'src/common/tenant/tenant.constants';
@Entity('sys_user', {
  comment: '用户信息表',
})
export class UserEntity extends BaseEntity {
  ...
  @Column({ type: 'varchar', name: 'user_scope', length: 16, default: PLATFORM_USER_SCOPE, comment: '用户作用域: platform / tenant' })
  ...
  @Column({ type: 'varchar', name: 'openid', length: 64, default: '', comment: '微信 openid' })
  public openid: string;

  @Column({ type: 'varchar', name: 'unionid', length: 64, default: '', comment: '微信 unionid' })
  public unionid: string;

  @Column({ type: 'varchar', name: 'user_source', length: 32, default: 'backend_manual', comment: '账号来源: backend_manual / wechat_mp' })
