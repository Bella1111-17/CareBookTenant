...
@Module({
  imports: [HttpModule, TypeOrmModule.forFeature([TenantCaregiverEntity, TenantOrgUnitEntity, TenantBadgeBindingEntity, TenantDailyReportEntity, BadgeDeviceEntity, AudioRecordEntity])],
